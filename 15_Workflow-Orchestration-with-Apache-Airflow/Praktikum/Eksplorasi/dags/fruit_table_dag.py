...
default_args = {
    ...
    'start_date': datetime(2023, 3, 1),  # Perbaikan tanggal start_date
...
dag = DAG(
    ...
    description='A simple DAG to fetch and store fruit data from an API',
...
create_fruits_table = PostgresOperator(
    ...
    postgres_conn_id='eksplorasi_postgres',
    sql="""
